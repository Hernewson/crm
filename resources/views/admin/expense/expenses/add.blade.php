...
@section('title')  Add New Expense  @endsection
    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Add New Expense </div>
                </div>
                ...
                <div class="card card-box">
                    ...
                    <div class="card-body " id="bar-parent">
                        <form method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="paid_by"
                                                   placeholder="Enter Name" name="paid_by" value="{{Auth::user()->name}}">
                                        </div>
                                    </div>
                            ...
                            <a href="{{ route('viewExpense') }}" class="btn btn-danger">Go Back</a>
