        ...
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li><a class="parent-item" href="javascript:">Expense Category</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
                    <li class="active">View All Expense Category</li>
                </ol>
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-box">
                                        <div class="card-head">
                                            <header>All Expense Category List</header>
                                        ...
                                        <div class="card-body ">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-6">
                                                    <div class="btn-group">
                                                        <a href="{{ route('addExpenseCategory') }}" id="addRow"
                                                ...
                                                <div class="col-md-6 col-sm-6 col-6">
                                                    <div class="btn-group pull-right">
                                                        ...
                                                        <ul class="dropdown-menu pull-right">
                                                            ...
                                                            <li>
                                                                <a href="{{route('generate_expensecategoryPDF')}}">
