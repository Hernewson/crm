                ...
                <div class="card-head">
                    ...
                    <div class="card-body " id="bar-parent">
                        <form method="post" action="" enctype="multipart/form-data">
                            ...
                            <button onclick="checkUserEmail()" type="submit" class="btn btn-primary">Update Customer</button>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-body">
                @if(!empty($student->image))
                    <img src="{{ asset('public/uploads/profile/'.$student->image) }}" alt="{{ $student->name }}" height="200px" width="auto">
                @else
                    <img src="{{ asset('public/uploads/profile/profile.png') }}" alt="{{ $student->name }}" height="200px" width="auto">
                @endif
            </div>
        </div>
    </div>
