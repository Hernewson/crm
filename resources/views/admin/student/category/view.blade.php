...
@section('title')  View All Student Category  @endsection
    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">All Student Category List</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
                                                           href="{{ route('admin.dashboard') }}">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
                    <li><a class="parent-item" href="javascript:">Student Category</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
                    <li class="active">View All Student Category</li>
                </ol>
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-box">
                                        <div class="card-head">
                                            <header>All Student Category List</header>
                                        ...
                                        <div class="card-body ">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-6">
                                                    <div class="btn-group">
                                                        <a href="{{ route('addCategory') }}" id="addRow"
                                            ...
                                            <div class="table-scrollable">
                                                <table
                                                    ...
                                                    <tbody>
                                                    @foreach($Student_category as $std_cat)
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td>
                                                                <a href="{{ route('editStudentCategory',$std_cat->id )}}"
                                                                   class="btn btn-primary btn-xs">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>

                                                                    <a href="javascript:" rel="{{ $std_cat->id }}" rel1="delete-studentcategory" class="btn btn-danger btn-xs deleteRecord">
