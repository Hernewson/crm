...
@section('title')  View All Teachers @endsection
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td class="patient-img">
                                                                @if(!empty($teacher->image))
                                                                    <img src="{{ asset('public/uploads/profile/'.$teacher->image) }}"
                                                                         alt="{{ $teacher->name }}">
                                                                @else
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="javascript:" rel="{{ $teacher->id }}" rel1="delete-teacher" class="btn btn-danger btn-xs deleteRecord">
