                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-body">
                        @if(!empty($teachers->image))
                            <img src="{{ asset('public/uploads/profile/'.$teachers->image) }}" alt="{{ $teachers->name }}" height="200px" width="auto">
                        @else
                            <img src="{{ asset('public/uploads/profile/profile.png') }}" alt="{{ $teachers->name }}" height="200px" width="auto">
                        @endif
                    </div>
                </div>
            </div>
