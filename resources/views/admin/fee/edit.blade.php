        ...
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li class="active">Edit Service Charge</li>
                </ol>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    <div class="card-head">
                        <header> Service Charge Details</header>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           placeholder="Enter Received By" name="paid_by">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                   ...
                                   <select id="mode_of_payment" placeholder="select" class="form-control" name="mode_of_payment"  data-validation="required"
                                                ...
                                                <option value="bank_deposite" @if ($payment->student_id="bank_deposite") selected @endif>Bank Deposit</option>
