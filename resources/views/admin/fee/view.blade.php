...
@section('title')  View All Due @endsection
    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">All Due List</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li class="active">View All Due</li>
                </ol>
            </div>
        </div>
        <div class="row">
                                        ...
                                        <div class="card-body ">
                                            ...
                                            <form action="{{ route('viewFees') }}" method="post">
                                                ...
                                                <div class="row small-spacing">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <button  type="submit" class="btn btn-primary">Generate Due Report </button>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ Auth::user()->name }}"
                                           placeholder=" Received By" name="received_by">
                                </div>
                                
                                <div class="form-group">
                                    <label for="received_b">Paid By</label>
                                    <input type="text" class="form-control"
                                           placeholder=" Paid By" name="paid_by">
                                </div>
