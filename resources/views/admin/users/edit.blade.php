            ...
            <div class="modal fade" id="imageModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-body">
                        @if(!empty($user->image))
                        <img src="{{ asset('public/uploads/profile/'.$user->image) }}" alt="{{ $user->name }}" height="200px" width="auto">
                            @else
                            <img src="{{ asset('public/uploads/profile/profile.png') }}" alt="{{ $user->name }}" height="200px" width="auto">
                            @endif
                    </div>
                </div>
            </div>
