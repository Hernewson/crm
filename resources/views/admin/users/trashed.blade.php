...
@section('title')  View Trashed Users @endsection
    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">All Trashed Users List</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li class="active">View All Trashed Users</li>
                </ol>
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-box">
                                        <div class="card-head">
                                            <header>All Trashed Users List</header>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-6">
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="{{ route('viewAllUsers') }}" id="addRow"
                                                           class="btn btn-primary">
                                                            All Users  <i class="fa fa-eye"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-6">
                                                ...
                                                <table
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="javascript:" rel="{{ $user->id }}" rel1="delete-user" class="btn btn-danger btn-xs deleteRecord">
