...
@section('title')  View All Exams @endsection
    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">All Exams List</div>
                </div>
                                        ...
                                        <div class="card-body ">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-6">
                                                    <div class="btn-group">
                                                        <a href="{{ route('addExams') }}" id="addRow"
                                                ...
                                                <table
                                                    ...
                                                    @foreach($exams as $exam)
                                                        <tr>
                                                            ...
                                                            <?php $course_name=$exam->courses->name ?>

                                                            <td>
                                                                <form action="{{route('viewCourseStudent')}}" method="post">
                                                                    @csrf

                                                                    <input type="hidden" value="{{$exam->courses->id}}" name="courseid">
                                                                    <input type="hidden" value="{{$exam->id}}" name="examid">
                                                                    <button type="submit" >{{$course_name}}</button>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button href="javascript:" rel="{{ $exam->id }}" rel1="delete-exam" class="btn btn-danger btn-xs deleteRecord" >
...
@section('scripts')
    ...
    <script>
        ...
        toastr.error("Result Has Been Already Submitted");
        @endif
    </script>
