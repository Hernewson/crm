    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Add New Email Template</div>
                </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    <div class="card-head">
                        <header>New Email Template Details</header>


                    </div>
                    <div class="card-body " id="bar-parent">
                        <form method="post" action="{{route('addEmailTemplate')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button  type="submit" class="btn btn-primary">Add New Email Template</button>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="attachment">Email Attachment </label>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#message').summernote({
                placeholder: 'Please Type Mail Template ',
                toolbar: [
