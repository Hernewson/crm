        ...
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li><a class="parent-item" href="javascript:">Customers</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
                    <li class="active">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="email_name" id="email_name" class="form-control" >
                                                        ...
                                                        <table
                                                            ...
                                                            @foreach($student as $std)
                                                                <tr class="odd gradeX">
                                                                    ...
                                                                    <td><input type="checkbox" id="email" value="{{ $std->email }}--{{ $std->fname }} {{ $std->lname }}" name="email[]" ></td>
...
@section('scripts')
    ...
    <script>
        ...
        $("#email_name").change(function () {
            ...
            var attach=$(this).find(':selected').data("attachment");
