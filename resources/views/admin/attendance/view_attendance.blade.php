                ...
                <div class="card card-box">
                    ...
                    <div class="card-body " id="bar-parent">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="datepicker" placeholder="Select Date"
                                        name="date" data-validation="required"
                        ...
                        <div class="row small-spacing">
                            ...
                            <div class="col-md-4">
                                ...
                                <span class="label label-rouded label-menu label-success"
                                    style="float: left; height: 30px !important; width: 139px; line-height: 20px; margin-top: 3px; border-radius: 0px">{{ $data->attendance }}</span>
                                @else
                        ...
                        <div class="row small-spacing">
                            ...
                            <div class="col-md-4">
                                ...
                                <span class="label label-rouded label-menu label-danger"
                                    style="float: left; height: 30px !important; width: 139px; line-height: 20px; margin-top: 3px; border-radius: 0px">{{ $data->attendance }}</span>
                                @else
                                <span class="label label-rouded label-menu label-primary"
                                    style="float: left; height: 30px !important; width: 139px; line-height: 20px; margin-top: 3px; border-radius: 0px">{{ $data->attendance }}</span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row small-spacing">
                            ...
                            <div class="col-md-3">
                                <input type="text" value="{{ $data->student->fname . $data->student->lname }}"
