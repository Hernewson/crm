...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <form action="{{ route('staffAttendance') }}" method="post">
                @csrf
                <div class="card card-box">
                    ...
                    <div class="card-body " id="bar-parent">
                        ...
                        <div class="row small-spacing">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <select name="staff_id[]" class="form-control" data-validation="required"
                        ...
                        <div class="pull-right">
                            <button type="submit" class="btn btn-yetprimary">Submit </button>
                        </div>

                    </div>
                    @else
                    <h1>No Staffs are available. </h1>
                    @endif
                </div>
            </form>
        </div>
