						...
						<div class="row">
							...
							<div class="col-lg-3 col-sm-6">
								<div class="overview-panel deepPink-bgcolor">
									...
									<div class="value white">
										<p class="sbold addr-font-h1" data-counter="counterup" data-value="{{ $users->count() }} ">
                                        {{ $users->count() }} 
                                        </p>
										<p>User</p>
									</div>
							...
							<div class="col-lg-3 col-sm-6">
								<div class="overview-panel blue-bgcolor">
									...
									<div class="value white">
										<p class="sbold addr-font-h1" data-counter="counterup" data-value="{{ $cashin->sum('amount_paid') }}">
										{{ $cashin->sum('amount_paid') }}
                                        </p>
										<p>CashIn</p>
									</div>
								</div>
