...
@section('title')  View All Expense Category @endsection
    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">All SMS Template List</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
                                                           href="{{ route('admin.dashboard') }}">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
                    <li><a class="parent-item" href="javascript:">SMS Template</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
                    <li class="active">View All SMS Template</li>
                </ol>
            </div>
        </div>
        <div class="row">
                                        ...
                                        <div class="card-body ">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-6">
                                                    <div class="btn-group">
                                                        <a href="{{ route('addSmsTemplate') }}" id="addRow"
                                                ...
                                                <table
                                                    ...
                                                    @foreach($smstemplates as $smstemplate)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{ route('editSmsTemplate', $smstemplate->id) }}"
                                                                   class="btn btn-primary btn-xs">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                                    <button href="javascript:" rel="{{ $smstemplate->id }}" rel1="delete-smstemplate" class="btn btn-danger btn-xs deleteRecord" >
