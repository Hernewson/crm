    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Edit  SMS Template -  {{ $smstemplate->name }}</div>
                </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    <div class="card-head">
                        <header>New SMS Template</header>
...
<div class="col-md-6">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" value="{{$smstemplate->name}}"
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea name="message" onKeyPress="return taLimit(this)" onKeyUp="return taCount(this,'myCounter')"  id='message' cols="30" rows="10" class="form-control">{{$smstemplate->message}}</textarea>
...
<button  type="submit" class="btn btn-primary">Update SMS Template</button>
